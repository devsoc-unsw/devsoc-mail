...
| GET       | /mail/view          | header `session`                       | `{ "mail": [ { "mailId": 1234, "sender": "eve@devsoc.mail", "subject": "amazing subject", "timeSent": 1683019484, "read": false } ] }` | Returns a list of all the user’s existing mail                  | 401 Invalid session                                                                                        |
